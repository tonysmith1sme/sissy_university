var app = function(t) {
	...
	function a(s) {
		...
		return t[s].call(r.exports, r, r.exports, a), r.l = !0, r.exports
	}
	return a.m = t, a.c = e, a.d = function(t, e, s) {
...
([
	function(t, e, a) {
		(function(e) {
			var a = "object" == typeof window && window.window === window ? window : "object" == typeof self && self.self === self ? self : "object" == typeof e && e.global === e ? e : this;
			...
			function r(t) {
				...
				return e.open("HEAD", t, !1), e.send(), e.status >= 200 && e.status <= 299
			}
			...
			var o = a.saveAs || "object" != typeof window || window !== a ? function() {} : "download" in HTMLAnchorElement.prototype ? function(t, e, o) {
				var l = a.URL || a.webkitURL,
					n = document.createElement("a");
				e = e || t.name || "download", n.download = e, n.rel = "noopener", "string" == typeof t ? (n.href = t, n.origin !== location.origin ? r(n.href) ? s(t, e, o) : i(n, n.target = "_blank") : i(n)) : (n.href = l.createObjectURL(t), setTimeout(function() {
				...
				if ((n || o && l) && "object" == typeof FileReader) {
					var u = new FileReader;
					u.onloadend = function() {
						var t = u.result;
						t = n ? t : t.replace(/^data:[^;]*;/, "data:attachment/file;"), i ? i.location.href = t : location = t, i = null
					}, u.readAsDataURL(t)
				} else {
	...
	function(t, e, a) {
		...
		class r {
			...
			static classExamcredits(t) {
				return 3 * r.classDailyTaskcredits(t)
			}
			static difficulty() {
			...
			static get majorsData() {
				return {
					1: {
						...
						safety_alert: "1.不建议在没有充分润滑的情况下使用不安全的道具进行扩张。2.扩张时一定要循序渐进，不能操作地过于激进，否则可能会撕裂黏膜导致感染，甚至死亡。3.扩张的时间也不宜过长因为扩张的性器官易遭到细菌的入侵。",
						tier: "major",
						daily1: "无",
						daily2: "无",
					...
					2: {
						...
						safety_alert: "使用贞操锁具不当可能会导致性器官永久损伤。",
						tier: "major",
						daily1: "无",
						daily2: "无",
					...
					3: {
						...
						safety_alert: "有可能诱发遗精、阳痿、摄护腺炎、精囊炎、神经衰弱、射精障碍等。",
						tier: "major",
						daily1: "无",
						daily2: "无",
					...
					5: {
						...
						safety_alert: "1.快速灌入大量液体可能导致水电解质失衡，造成水中毒。考虑使用生理盐水。2.使用刺激性液体（如水温过冷过热、汽水、酒、辣椒水、肥皂水等）有可能导致结肠出现生理性病变或肠穿孔。两者皆为有可能导致生命危险的严重疾病。3.酒精经大肠吸收会直接扩散至全身，而不像胃部吸收，先经过肝脏解毒。酒或含酒精的液体灌肠容易造成快速酒精中毒。4.水温过冷可能导致失温症，可能造成发抖、意识混浊、精神错乱、失去意识，乃至死亡。而过烫可能造成内部烫伤。应使用37摄氏度水温。5.水压太大/速度太快，可能会冲破肠壁造成腹腔内大污染，死亡率很高。6.灌入过多液体可能导致大肠破裂，腹腔大污染死亡率很高。7.大量灌入汽水、可乐、香槟等含气液体是危险的。8.肥皂水灌肠已被证实会造成结肠/大肠癌发病率提高，请避免使用肥皂水灌肠。9.灌肠后产生的排泄物需要仔细清理，以免造成反复细菌感染。如果在排泄物中发现白色长条/方片，可能是寄生虫，请治好后再灌肠。",
						tier: "major",
						daily1: "无",
						daily2: "无",
					...
					7: {
						...
						safety_alert: "被使用嘴穴时务必使用鼻子呼吸，否则可能窒息而死。",
						tier: "major",
						daily1: "无",
						daily2: "无",
					...
					9: {
						...
						safety_alert: "使用面罩控制呼吸时务必注意时间，否则可能窒息而死。",
						tier: "major",
						daily1: "无",
						daily2: "无",
		...
		class d {
			static getImage(t, e) {
				...
				if (t && e) {
					...
					switch (e) {
						case "major":
							s = u.MajorsImages[t], a = u.ImagesData[s];
							break;
						case "class":
							s = u.ClassesImages[t], a = u.ImagesData[s];
							break;
						case "partner":
							s = u.PartnersImages[t], a = u.ImagesData[s];
							break;
						case "club":
							s = u.ClubsImages[t], a = u.ImagesData[s];
							break;
						case "punishment":
							s = u.PunishmentsImages[t], a = u.ImagesData[s]
					}
				} else if (t)
					a = u.ImagesData[t];
				else {
		...
		class c {
			...
			static LoadData() {
				let t = l.getMajorsData(),
					e = l.getCompletedMajors(),
					a = l.getCurrentMajorId(),
					s = $(".card-container"),
					r = $('<div class="row">');
				for (let s in t) {
					let i = t[s];
					...
					l.append($(`<img class="card-img-top hoverable" src="${n}.webp" onerror="this.onerror=null; this.src='${n}.jpg'" alt="${i.name}">`).on("click", function() {
						...
						dt.ViewMajor(t)
					})).append($('<h4 class="card-title">').text(i.name).append($(`<h6>${i.name2}</h6>`))), e.find(t => t == s) ? l.append($('<div class="indicator-complete">Completed</div>')) : u && l.append($('<div class="indicator-active">已激活专业</div>')), $(r).append(o.append(l))
				}
				s.append(r)
			}
		}
		...
		class g {
			static increaseActivePerksNum() {
				...
				t++, localStorage.setItem("activePerksNum", t)
			}
		...
		class m {
			...
			static debug(t, e) {
				e && console.log(e), alert(t)
			}
			static handleAjaxError(t) {
				console.log(t), alert("错误,见F12控制台")
			}
			...
			static traversePrerequisites(t) {
				...
				return function t(a) {
					...
					(t), Array.from(new Set(e.sort((t, e) => t - e)))
			}
		}
		class p {
			static getClubsData() {
			...
			static addActiveClub(t) {
				...
				e.push(t), localStorage.setItem("activeClubs", JSON.stringify(e))
			}
			static resetActiveClubs() {
				localStorage.setItem("activeClubs", JSON.stringify([])), g.setActivePerks([]), localStorage.setItem("activePerks", JSON.stringify([])), localStorage.setItem("activePerksNum", "0"), localStorage.setItem("maxActiveClubs", JSON.stringify(s.MAX_CLUBS)), localStorage.setItem("maxActivePerks", JSON.stringify(s.MAX_PERKS))
			}
		...
		class y {
			...
			static resetActivePartners() {
				localStorage.setItem("activePartners", JSON.stringify([])), localStorage.setItem("activePartnerPerks", JSON.stringify([]))
			}
		}
		class b {
			...
			static addTaskTimer(t) {
				...
				e.push(t), b.setTasksTimers(e)
			}
			static removeTaskTimer(t) {
				let e = b.getTasksTimers(),
					a = e.findIndex(e => e.sourceId == t.sourceId);
				a >= 0 && (e.splice(a, 1), b.setTasksTimers(e))
			}
		...
		class f {
			...
			static resetClasses() {
				localStorage.setItem("currentClasses", JSON.stringify([])), localStorage.setItem("todayClasses", JSON.stringify([])), b.resetTasks()
			}
		}
		class w {
			static view(t) {
				w.LoadHtml(), w.LoadData()
			}
			static LoadHtml() {
			...
			static LoadData() {
				let t = f.getClassesData(),
					e = f.getCompletedClasses(),
					a = f.getCurrentClasses(),
					i = $("#beginner-classes-container"),
					o = $("#intermediate-classes-container"),
					l = $("#advanced-classes-container"),
					n = $("#master-classes-container");
				for (let u in t) {
					let c = t[u];
					if (c.community)
						continue;
					let h = !1,
						g = c.prerequisites.split(" ").filter(t => t);
					for (let t of g) {
						e.some(e => e == t) || (h = !0)
					}
					"intermediate" == c.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_INTERMEDIATE ? h = !0 : "advanced" == c.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_ADVANCED ? h = !0 : "master" == c.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_MASTER && (h = !0);
					let m = e.some(t => t == u),
						p = a.some(t => t == u),
						y = $('<div class="col-auto">'),
						b = d.getImage(c.id, "class").url,
						f = $('<div class="card border-secondary" >');
					f.append($(`<img class="card-img-top hoverable" src="${b}.webp" onerror="this.onerror=null; this.src='${b}.jpg'" alt="${c.name}">`)).on("click", function() {
						...
						dt.ViewClass(t)
					}).append($('<h4 class="card-title">').text(c.name).append($(`<h6>${c.name2}</h6>`))), h ? f.append($('<div class="indicator-locked">未解锁</div>')) : m ? f.append($('<div class="indicator-complete">Completed</div>')) : p && f.append($('<div class="indicator-active">课程已激活</div>')), "beginner" === c.tier ? $(i).append(y.append(f)) : "intermediate" === c.tier ? $(o).append(y.append(f)) : "advanced" === c.tier ? $(l).append(y.append(f)) : "master" === c.tier && $(n).append(y.append(f))
				}
			}
		}
		class U {
		...
		class v {
			...
			static setRequiredCredits(t) {
				return t || m.debug("Required credits bugged. See console", t), localStorage.setItem("requiredCredits", JSON.stringify(t))
			}
		...
		class x {
			...
			static applyMultipliersToDuration(t, e) {
				let a = S.getFinalTaskMultiplier(),
					s = 0;
				return e && (s = S.getTagMultiplier(e)), t *= a += Number(s), t = Math.round(t)
			}
			...
			static dateObjectToHumanTime(t) {
				let e = parseInt(t / 1e3 % 60),
					a = parseInt(t / 6e4 % 60),
					s = parseInt(t / 36e5 % 24),
					r = Math.floor(t / 6e4 / 1440);
				return s = s < 10 ? "0" + s : s, a = a < 10 ? "0" + a : a, e = e < 10 ? "0" + e : e, r > 0 ? `${r}:${s}:${a}:${e}` : `${s}:${a}:${e}`
			}
			static urlToObject(t) {
				t || (t = location.href);
				let e = t.indexOf("?"),
					a = t.indexOf("#"); - 1 == a && (a = t.length);
				let s = -1 == e || a == e + 1 ? t.substring(a) : t.substring(e + 1, a),
					r = {},
					i = location.pathname.substring(location.pathname.lastIndexOf("/") + 1);
				return r.htmlFile = i, s.split("&").forEach(function(t) {
					if (!t)
						return;
					let e = (t = t.split("+").join(" ")).indexOf("="),
						a = e > -1 ? t.substr(0, e) : t,
						s = e > -1 ? decodeURIComponent(t.substr(e + 1)) : "",
						i = a.indexOf("[");
					if (-1 == i)
						r[decodeURIComponent(a)] = s;
					else {
						let t = a.indexOf("]", i),
							e = decodeURIComponent(a.substring(i + 1, t));
						a = decodeURIComponent(a.substring(0, i)), r[a] || (r[a] = []), e ? r[a][e] = s : r[a].push(s)
					}
				}), r
			}
			static minutesToTime(t) {
				let e = Math.floor(t / 1440),
					a = Math.floor((t - 1440 * e) / 60),
					s = Math.round(t % 60),
					r = "";
				return e > 0 && (r += `${e} 天`), a > 0 && (e && !s ? r += " 和" : e && (r += ";"), r += ` ${a} 小时`), s > 0 && ((e || a) && (r += " 和"), r += ` ${s} 分钟`), r.trim()
			}
		...
		class S {
			static calculateClubTaskMultiplier() {
				let t = p.getClubsData(),
					e = g.getActiveClubPerks(),
					a = 0,
					s = 0;
				for (let r of e) {
					let e = t[r.sourceId];
					if (1 == r.perk1) {
						a += x.getPercentageFromText(e.perk1), s++
					}
					if (1 == r.perk2) {
						a += x.getPercentageFromText(e.perk2), s++
					}
				}
				return isNaN(a) ? 0 : isNaN(s) ? void 0 : (a < 0 && (a = 0), g.setActivePerksNum(s), a)
			}
			static calculateDifficultyTaskMultiplier() {
				let t = y.getPartnersData(),
					e = 0,
					a = g.getActivePartnerPerks();
				for (let s of a) {
					let a = t[s.sourceId];
					a.tags.split(" ").some(t => "all" == t || "justDifficulty" == t) && (1 == s.perk1 && (e += x.getPercentageFromText(a.job1)), 1 == s.perk2 && (e += x.getPercentageFromText(a.job2)))
				}
				return e
			}
			static getTagMultiplier(t) {
				...
				let e = y.getPartnersData(),
					a = 0,
					s = g.getActivePartnerPerks();
				for (let r of s) {
					let s = e[r.sourceId],
						i = s.tags.split(" ");
					t.some(t => i.indexOf(t) >= 0) && (1 == r.perk1 && (a += x.getPercentageFromText(s.job1)), 1 == r.perk2 && (a += x.getPercentageFromText(s.job2)))
				}
				return a
			}
			static calculateFinalTaskMultiplier() {
				...
				return S.setFinalTaskMultiplier(t.toFixed(2)), t.toPrecision(2)
			}
			static setFinalTaskMultiplier(t) {
				t < .5 && (t = .5), localStorage.setItem("finalTaskMultiplier", JSON.stringify(t))
			}
		...
		class I {
			static joinClub(t, e) {
				null === l.getCurrentMajor() && (alert("你要先选择一个专业!!!"), dt.ViewMajors());
				let a = p.getClubsData(),
					r = p.getActiveClubs(),
					i = p.getMaxActiveClubs(),
					o = p.getClubById(t);
				if (r.includes(o.id))
					return void alert("你已经参加这个社团了！");
				if (r.length >= i)
					return void alert("你参加的社团数不能超过 " + s.MAX_CLUBS + "个。");
				if (2 == o.tier) {
					if (v.getCredits() < s.REQUIRED_CREDITS_UNLOCK_ELITE_CLUBS)
						return void alert(`你需要至少 ${s.REQUIRED_CREDITS_UNLOCK_ELITE_CLUBS} 点学分才能参加这个精英社团。`);
					for (let t of r) {
						if (2 == a[t].tier)
							return void alert(`你不能加入超过 ${s.MAX_CLUBS_ELITE} 个的精英社团！`)
					}
				}
				...
				n.push(u), g.setActivePerks(n), p.addActiveClub(o.id), 1 != e && (alert("你已经报名参加了 " + o.name), dt.ViewSchedule())
			}
			static leaveClub(t) {
				let e = p.getActiveClubs(),
					a = g.getActiveClubPerks(),
					s = e.findIndex(e => e == t.id);
				e.splice(s, 1), localStorage.setItem("activeClubs", JSON.stringify(e));
				let r = a.findIndex(e => e.sourceId == t.id);
				a.splice(r, 1), g.setActivePerks(a), S.calculateFinalTaskMultiplier(), I.calculateClubSkips(), 10 == t.id && v.resetRequiredCredits(), 2 == t.tier && localStorage.setItem("classSkipsAvailable", JSON.stringify(0)), alert("你已经成功地离开了社团!"), dt.ViewSchedule()
			}
			static increaseClubSkips(t) {
				let e = localStorage.getItem("classSkipsAvailable"),
					a = Number(e) + Number(t);
				isNaN(a) ? m.debug("使用公假条错误，请看控制台！", a) : p.setClassSkipsAvailable(a)
			}
			static calculateClubSkips() {
				...
				for (let s of e) {
					...
					if (p.getActiveClubs().find(t => 10 == t) && a >= 2)
						return void p.setClassSkipsAvailable(2);
		...
		class T {
			static isTodayWeekend() {
				return "Saturday" == r.todayName() || "Sunday" == r.todayName()
			}
			...
			static passDay() {
				try {
					...
					let t = (new Date).getDate(),
						e = g.getActiveClubPerks();
					for (let t of e)
						10 != t.sourceId && (t.perk1 = !1, t.perk2 = !1);
					g.setActivePerks(e), localStorage.setItem("activePerksNum", "0");
					...
					let s = j.isEasyModeEnabled(),
						i = r.todayName();
					if (!("Sunday" == i || "Monday" == i) && !s) {
						let t = f.getAttendedClassesToday(),
							e = f.getTodayClasses(),
							a = b.getTasksTimers();
						for (let s of e) {
							let e = t.find(t => t == s),
								r = a.some(t => t.sourceId == s);
							e || r || P.skipClass(s)
						}
					}
					S.calculateFinalTaskMultiplier(), I.calculateClubSkips();
					let o = b.getTasksTimers();
					o.forEach(function(t, e) {
						t.isEnded && o.splice(e, 1)
					}), b.setTasksTimers(o), f.setAttendedClassesToday([]), U.submittedProgressTodayFalse(), C.setRolledToday(!1), C.setLastResult(null), localStorage.setItem("lastDate", JSON.stringify(t)), P.calculateTodayClasses(), window.location.reload()
				} catch (t) {
					alert("错误，见控制台并报告给抖喵酱！"), console.log(t)
				}
			}
		}
		class P {
			static joinClass(t) {
				try {
					let e = f.getClassesData(),
						a = f.getCurrentClasses(),
						i = f.getCompletedClasses(),
						o = s.MAX_ACTIVE_CLASSES,
						n = e[t];
					if (null == l.getCurrentMajor())
						return alert("你要先选择一个专业!!!"), dt.ViewMajors(), !1;
					for (let e of a)
						if (e == t)
							return void alert("You have already signed up for " + n.name);
					if (a.length >= o)
						return void alert("你不能选择超过 " + o + " 个课程");
					for (let e of i)
						if (e == t)
							return void alert("你以前已经完成了这门课!");
					if ("intermediate" == n.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_INTERMEDIATE)
						return void alert(`你至少需要 ${s.REQUIRED_CREDITS_UNLOCK_INTERMEDIATE} 点学分才能选择普通课程！`);
					if ("advanced" == n.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_ADVANCED)
						return void alert(`你至少需要 ${s.REQUIRED_CREDITS_UNLOCK_ADVANCED} 点学分才能选择高级课程！`);
					if ("master" == n.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_MASTER)
						return void alert(`你至少需要 ${s.REQUIRED_CREDITS_UNLOCK_MASTER} 点学分才能选择大师课程！`);
					let u = !1,
						d = n.prerequisites.split(" ").filter(t => t);
					for (let t of d) {
						let a = e[t];
						!1 === i.some(e => e == t) && (alert("你需要完成前置课程 " + a.name + " ！!"), u = !0)
					}
					if (!0 === u)
						return;
					a.push(t), f.setCurrentClasses(a), P.calculateTodayClasses(), alert(`您已经成功选择了 ${n.name}.`), dt.RefreshView()
				} catch (t) {
					A.catchError(t)
				}
			}
			static leaveClass(t) {
				try {
					let e = f.getClassById(t),
						a = f.getCurrentClasses(),
						s = a.findIndex(e => e == t);
					a.splice(s, 1), b.removeTaskTimer(t);
					let r = 2 * f.getClassDailyTaskcredits(e);
					A.decreasecurrentCredits(r), f.setCurrentClasses(a), P.calculateTodayClasses(), alert(`你已经退选了${e.name}. 这门课程，因为退选扣除 ${r} 点学分！！`), dt.RefreshView()
				} catch (t) {
					A.catchError(t)
				}
			}
			static attendClass(t, e, a) {
				try {
					let s = f.getClassById(t),
						r = f.getAttendedClassesToday();
					e && (r.push(t), f.setAttendedClassesToday(r));
					let i = f.getAttendedClasses();
					if (i.find(e => e == t) || (i.push(t), f.setAttendedClasses(i)), e) {
						let e = f.getTodayClasses(),
							a = e.findIndex(e => e == t);
						e.splice(a, 1), f.setTodayClasses(e)
					}
					let o = f.getClassDailyTaskcredits(s);
					a || (a = 0);
					let l = o + a;
					A.increasecurrentCredits(l), dt.RefreshView()
				} catch (t) {
					A.catchError(t)
				}
			}
			static passClass(t, e) {
				try {
					let a = f.getClassById(t),
						s = f.getCurrentClasses(),
						i = s.findIndex(e => e == t); - 1 != i && (s.splice(i, 1), f.setCurrentClasses(s));
					let o = f.getCompletedClasses();
					o.push(t), f.setCompletedClasses(o);
					let l = f.getAttendedClassesToday();
					l.push(t), f.setAttendedClassesToday(l);
					let n = f.getTodayClasses(); - 1 != (i = n.findIndex(e => e == t)) && (n.splice(i, 1), f.setTodayClasses(n));
					let u = r.classExamcredits(a);
					e || (e = 0);
					let d = u + e;
					A.increasecurrentCredits(d), dt.RefreshView()
				} catch (t) {
					A.catchError(t)
				}
			}
			static skipClass(t) {
				try {
					let e = f.getClassById(t),
						a = f.getAttendedClassesToday();
					a.push(t), f.setAttendedClassesToday(a);
					let s = f.getTodayClasses(),
						r = s.findIndex(e => e == t);
					if (-1 != r && (s.splice(r, 1), f.setTodayClasses(s)), f.getClassSkipsAvailable() <= 0)
						alert(`你由于逃课将受到处分，处分内容是 ${e.name}!`), E.rollPunishment(1, !0);
					else {
						let t = Number(f.getClassSkipsAvailable());
						t -= 1, U.setClassSkipsAvailable(t)
					}
				} catch (t) {
					A.catchError(t)
				}
			...
			static failClassTask(t) {
				try {
					...
					e.push(t), f.setAttendedClassesToday(e);
					let a = f.getTodayClasses(),
						s = a.findIndex(e => e == t);
					a.splice(s, 1), f.setTodayClasses(a), dt.RefreshView()
				} catch (t) {
					A.catchError()
				}
			}
		...
		class j {
			static switchEasyMode() {
				...
				t = !t, localStorage.setItem("easyMode", JSON.stringify(t)), P.calculateTodayClasses(), window.location.reload()
			}
		...
		class A {
			...
			static increasecurrentCredits(t, e) {
				if (t = Number(t), 1 != e) {
					let e = r.difficulty();
					2 == e ? t += 1 : 3 == e ? t += 2 : 4 == e ? t += 3 : 5 == e && (t += 4)
				}
				v.increaseCredits(t)
			}
			...
			static uploadProgressData() {
				let t = $("#form-ranking input[name=ranking-name]").val(),
					e = l.getCurrentMajor(),
					a = h.getPunishmentsDoneNum(),
					s = f.getCompletedClasses();
				if (e || (alert("你要先选择一个专业!!!"), dt.ViewMajors()), j.isEasyModeEnabled())
					return void alert("排行榜不适用于简单模式玩家");
				if (!t || 0 === t.length)
					return void alert("请输入一个名字");
				if ("true" == A.isSubmittedProgressToday())
					return void alert("您今天已经提交了您的进度!");
				let r = 0,
					i = l.getCompletedMajors();
				for (let t of i)
					r += 160;
				for (let t of s) {
				...
				$.ajax({
					...
					$.ajax({
						...
						data: o
					}).then(alert("进度已提交!")).catch(m.handleAjaxError), U.submittedProgressTodayTrue(), dt.RefreshView()
				}).catch(m.handleAjaxError)
			}
			static catchError(t) {
				alert("错误-请参阅控制台(F12)并报告给抖喵酱！"), console.log(t)
			}
		}
		class E {
			static rollPunishment(t, e = null, a = 0) {
				null == localStorage.getItem("currentMajor") && (alert("你要先选择一个专业!!!"), dt.ViewMajors());
				let r = h.getCurrentPunishments(),
					i = h.getMaxPunishments();
				if (r.length >= Number(i) + a)
					return void(1 != t || e || alert(`你不能拥有超过 ${i} 个处分，请尽快处理处分！！！`));
				let o = h.getPunishmentsData(),
					l = o;
				h.IsUnlockedHardcorePunishments() || (l = Object.values(o).filter(t => 1 == t.tier || 2 == t.tier)), h.IsUnlockedHardPunishments() || (l = Object.values(o).filter(t => 1 == t.tier)), console.log(l);
				let n = (l = Object.entries(l)).length;
				for (let a = 0; a < t; a++) {
					for (;;) {
						let a = l[m.generateRandomIndex(n)][1];
						if (!r.some(t => t == a.id)) {
							1 != t || e || alert(`你的处分是 ${a.name}`), r.push(a.id), localStorage.setItem("currentPunishments", JSON.stringify(r));
							break
						}
					}
			...
			static rollPunishmentLight(t = 0) {
				...
				let e = h.getCurrentPunishments(),
					a = h.getMaxPunishments();
				if (e.length >= Number(a) + t)
					return void alert(`你不能拥有超过 ${a} 个处分，请尽快处理！！！`);
				let s = h.getPunishmentsData(),
					r = Object.values(s).filter(t => 1 == t.tier),
					i = (r = Object.entries(r)).length;
				for (;;) {
					let t = r[m.generateRandomIndex(i)][1];
					if (!e.some(e => e == t.id))
						return e.push(t.id), alert("你的处分是 is " + t.name), localStorage.setItem("currentPunishments", JSON.stringify(e)), void dt.ViewSchedule()
				}
			}
			static rollPunishmentHeavy(t = 0) {
				if (null == localStorage.getItem("currentMajor"))
					return alert("你要先选择一个专业!!!"), dt.ViewMajors(), !1;
				let e = h.getCurrentPunishments(),
					a = h.getMaxPunishments();
				if (e.length >= Number(a) + t)
					return void alert(`你不能拥有超过 ${a} 个处分，请尽快做完！！！`);
				if (!1 === h.IsUnlockedHardPunishments())
					return void alert("你还没有解锁重型处分。");
				let s = h.getPunishmentsData(),
					r = Object.values(s).filter(t => 2 == t.tier),
					i = (r = Object.entries(r)).length;
				for (;;) {
					let t = r[m.generateRandomIndex(i)][1];
					if (!e.some(e => e == t.id))
						return e.push(t.id), alert("你的处分是 " + t.name), localStorage.setItem("currentPunishments", JSON.stringify(e)), void dt.ViewSchedule()
				}
			}
			static rollPunishmentHardcore(t = 0) {
				...
				if (e.length >= Number(a) + t)
					return void alert(`你不能拥有超过 ${a} 个处分，请尽快做完！！！`);
				if (0 == h.IsUnlockedHardcorePunishments())
					return void alert("你没有启用核心处分。");
				if (0 == A.unlockedHardPunishments())
					return void alert("你还没有100学分！");
				let s = h.getPunishmentsData(),
					r = Object.values(s).filter(t => 3 == t.tier),
					i = (r = Object.entries(r)).length;
				for (;;) {
					let t = r[m.generateRandomIndex(i)][1];
					if (!e.some(e => e == t.id))
			...
			static completePunishment(t) {
				let e = h.getPunishmentById(t),
					a = h.getCurrentPunishments(),
					s = a.findIndex(e => e == t);
				a.splice(s, 1), localStorage.setItem("currentPunishments", JSON.stringify(a));
				let r = Number(h.getPunishmentsDoneNum());
				r++, localStorage.setItem("punishmentsDoneNum", JSON.stringify(r)), alert(e.name + " 完成"), dt.RefreshView()
			}
			static rerollPunishment(t) {
				let e = h.getPunishmentById(t);
				1 == e.tier ? E.rollPunishmentLight(1) : 2 == e.tier ? A.unlockedHardPunishments() ? E.rollPunishmentHeavy(1) : E.rollPunishmentLight(1) : 3 == e.tier ? A.unlockedHardPunishments() ? h.IsUnlockedHardcorePunishments() ? E.rollPunishmentHardcore(1) : E.rollPunishmentHeavy(1) : E.rollPunishmentLight(1) : E.rollPunishment(1, !1, 1);
				...
				let i = r / 2;
				A.decreasecurrentCredits(i), alert(e.name + " 再roll一次! 你失去了: " + i + " 点学分！！"), dt.RefreshView()
			}
			static failPunishment(t) {
				let e = h.getPunishmentById(t),
					a = h.getCurrentPunishments(),
					s = a.findIndex(t => t == e.id);
				a.splice(s, 1), localStorage.setItem("currentPunishments", JSON.stringify(a));
				let r = 0;
				switch (e.tier) {
					case "1":
				...
				A.decreasecurrentCredits(r), alert(e.name + "失败！! 你失去了:  " + r + " 点学分！！"), dt.RefreshView()
			}
			static switchHardcorePunishments() {
				let t = h.IsUnlockedHardcorePunishments();
				t = !t, h.setUnlockedHardcorePunishments(t), location.reload()
			}
		}
		class N {
			static invitePartner(t, e) {
				...
				let a = y.getActivePartners(),
					r = y.getPartnersData()[t];
				if (!r)
					return;
				if (a.length >= s.MAX_PARTNERS)
					return void alert(`你不能选择超过 ${s.MAX_PARTNERS} 个姬友！！`);
				if (a.find(e => e == t))
					return void alert("你和这个姬友已经是好朋友了！！");
				...
				return i.push(o), g.setActivePartnerPerks(i), a.push(t), y.setActivePartners(a), 1 != e ? (alert(`${r.name} 已成为你的姬友！！`), dt.ViewSchedule(), !1) : void 0
			}
			static kickPartner(t) {
				let e = y.getActivePartners(),
					a = y.getPartnerById(t),
					s = e.findIndex(e => e == t);
				e.splice(s, 1), y.setActivePartners(e);
				let r = g.getActivePartnerPerks(),
					i = r.findIndex(e => e.sourceId == t);
				return r.splice(i, 1), g.setActivePartnerPerks(r), alert(`你已经和 ${a.name}绝交了！ :(`), dt.ViewSchedule(), !1
			}
		}
		class M {
		...
		class D {
			static updateGame(t = !1) {
				try {
					let e = M.getGameVersion();
					e < 1.65 && (console.log("版本低于1.65, 无法迁移你的课程"), D.migratePartners(), D.migrateMajors(), D.migrateClasses(), D.migrateClubs(), D.migratePunishments(), D.migrateDates()), e < 1.7 && (console.log("版本低于1.70，无法迁移日期"), D.migrateDates()), D.updateMajors(), D.updateClasses(), D.updateClubs(), D.updatePartners(), D.updatePunishments(), O.seedData(), S.calculateFinalTaskMultiplier(), P.calculateTodayClasses(), localStorage.setItem("gameVersion", JSON.stringify(s.CURRENT_VERSION)), t || alert("系统更新"), dt.RefreshView()
				} catch (t) {
					alert("错误，见控制台并报告给抖喵酱！"), console.log(t)
				}
			}
			static migrateMajors() {
				let t = l.getMajorsData(),
					e = JSON.parse(localStorage.getItem("currentMajor"));
				if (!e)
					return localStorage.removeItem("majorsData"), void alert("你需要重新选择一个专业！！！");
				let a = e.id;
				t[a] && localStorage.setItem("currentMajor", JSON.stringify(a));
				...
				localStorage.setItem("completedMajors", JSON.stringify(r)), localStorage.removeItem("majorsData")
			}
			static migrateClasses() {
				let t = f.getClassesData(),
					e = f.getCurrentClasses(),
					a = [];
				for (let s of e) {
					let e = s.id;
					t[e] && a.push(e)
				...
				f.setCompletedClasses(d), localStorage.removeItem("classesData")
			}
			static migrateClubs() {
				let t = p.getActiveClubs();
				p.resetActiveClubs(), v.resetRequiredCredits();
				for (let e of t)
					I.joinClub(e, !0);
			...
			static migratePunishments() {
				...
				localStorage.removeItem("currentPunishments"), localStorage.removeItem("maxPunishments");
				...
				localStorage.setItem("currentPunishments", JSON.stringify(a)), localStorage.removeItem("punishmentsData")
			}
			static updateMajors() {
				let t = l.getMajorsData(),
					e = l.getCurrentMajorId(),
					a = [];
				if (M.getGameVersion() <= 1.7 && (a = [6, 7, 13]), a.some(t => t == e))
					return console.log("major has been reworked"), void l.setCurrentMajor(null);
				let s = l.getCompletedMajors();
				s.some(t => "4" == t) && (s.push("7"), l.setCompletedMajors(s)), t[e] || l.setCurrentMajor(null)
			}
			static updateClasses() {
				let t = f.getClassesData(),
					e = [];
				JSON.parse(localStorage.getItem("gameVersion")) <= 1.7 && (e = [315, 415, 109, 209, 309, 409, 412]);
				...
				f.setCompletedClasses(c), P.calculateTodayClasses(), localStorage.removeItem("classesData")
			}
			static updateClubs() {
				let t = p.getActiveClubs();
				p.resetActiveClubs(), v.resetRequiredCredits();
		...
		class O {
			static seedData() {
				null == localStorage.getItem("currentMajor") && localStorage.setItem("currentMajor", JSON.stringify(0)), null == localStorage.getItem("currentCredits") && localStorage.setItem("currentCredits", "0"), null == localStorage.getItem("requiredCredits") && localStorage.setItem("requiredCredits", JSON.stringify(s.REQUIRED_CREDITS_GRADUATION)), null == localStorage.getItem("completedMajors") && localStorage.setItem("completedMajors", JSON.stringify([])), null == localStorage.getItem("currentClasses") && localStorage.setItem("currentClasses", JSON.stringify([])), null == localStorage.getItem("todayClasses") && localStorage.setItem("todayClasses", JSON.stringify([])), null == localStorage.getItem("completedClasses") && localStorage.setItem("completedClasses", JSON.stringify([])), null == localStorage.getItem("attendedClasses") && localStorage.setItem("attendedClasses", JSON.stringify([])), null == localStorage.getItem("attendedClassesToday") && localStorage.setItem("attendedClassesToday", JSON.stringify([])), null == localStorage.getItem("activeClubs") && localStorage.setItem("activeClubs", JSON.stringify([])), null == localStorage.getItem("activePerks") && localStorage.setItem("activePerks", JSON.stringify([])), null == localStorage.getItem("classSkipsAvailable") && localStorage.setItem("classSkipsAvailable", "0"), null == localStorage.getItem("activePerksNum") && localStorage.setItem("activePerksNum", "0"), null == localStorage.getItem("maxActiveClubs") && localStorage.setItem("maxActiveClubs", JSON.stringify(s.MAX_CLUBS)), null == localStorage.getItem("maxActivePerks") && localStorage.setItem("maxActivePerks", JSON.stringify(s.MAX_PERKS)), null == localStorage.getItem("currentPunishments") && localStorage.setItem("currentPunishments", JSON.stringify([])), null == localStorage.getItem("hardcorePunishmentsStatus") && localStorage.setItem("hardcorePunishmentsStatus", JSON.stringify(!1)), null == localStorage.getItem("tasks") && localStorage.setItem("tasks", JSON.stringify([])), null == localStorage.getItem("activePartners") && localStorage.setItem("activePartners", JSON.stringify([])), null == localStorage.getItem("activePartnerPerks") && localStorage.setItem("activePartnerPerks", JSON.stringify([])), null == localStorage.getItem("finalTaskMultiplier") && localStorage.setItem("finalTaskMultiplier", "1"), null == localStorage.getItem("clubTaskMultiplier") && localStorage.setItem("clubTaskMultiplier", "0"), null == localStorage.getItem("difficulty") && localStorage.setItem("difficulty", "1"), null == localStorage.getItem("difficultyTaskMultiplier") && localStorage.setItem("difficultyTaskMultiplier", "0"), null == localStorage.getItem("communityContentStatus") && localStorage.setItem("communityContentStatus", JSON.stringify(!0)), null == localStorage.getItem("punishmentsDoneNum") && localStorage.setItem("punishmentsDoneNum", "0"), null == localStorage.getItem("clubActivitiesDoneNum") && localStorage.setItem("clubActivitiesDoneNum", "0"), null == localStorage.getItem("lastDate") && localStorage.setItem("lastDate", JSON.stringify((new Date).getDate())), null == localStorage.getItem("IsSubmittedProgressToday") && localStorage.setItem("IsSubmittedProgressToday", "false"), null == localStorage.getItem("finalThesisInProgress") && localStorage.setItem("finalThesisInProgress", "false"), null == localStorage.getItem("easyMode") && localStorage.setItem("easyMode", JSON.stringify(!1)), localStorage.setItem("firstRun", JSON.stringify(!1)), localStorage.setItem("gameVersion", JSON.stringify(s.CURRENT_VERSION)), localStorage.setItem("view", JSON.stringify("index"))
			}
			static exportLocStorage() {
				let t = new Blob([JSON.stringify(localStorage)], {
					...
					e = new Date,
					a = `${e.getFullYear()}-${1==(e.getMonth()+1).toString().length?`
				0$ {
					e.getMonth() + 1
				}
				`:e.getMonth()+1}-${1==e.getDate().toString().length?`
				0$ {
					e.getDate()
				}
				`:e.getDate()}`;
				...
				try {
					...
					a.onload = function(t) {
						...
						Object.keys(a).forEach(function(t) {
							"lastDate" === t ? a[t] != JSON.stringify(r) && (s = !0) : localStorage.setItem(t, a[t])
						}), s && (localStorage.setItem("attendedClassesToday", JSON.stringify([])), localStorage.setItem("todayClasses", JSON.stringify([]))), localStorage.setItem("lastDate", JSON.stringify(r)), D.updateGame(), alert("Data loaded"), window.location.reload()
					}, a.readAsText(e)
				} catch (t) {
					console.log(t), alert("Something went wrong, see console!")
				}
			}
		}
		class F {
			static signMajor(t) {
				if (null == l.getCurrentMajor()) {
					...
					return localStorage.setItem("currentMajor", JSON.stringify(t)), alert("您已经成功选择了 " + e.name + "专业!!"), dt.ViewProgress(), !1
				}
				return alert("你已经选择了一个专业。"), dt.ViewProgress(), !1
			}
			static dropMajor(t) {
				let e = l.getMajorById(t);
				l.resetCurretnMajor(), f.resetClasses(), y.resetActivePartners(), p.resetActiveClubs(), alert(`你已经退选了 ${e.name}这个专业. 你将会收到 ${s.PUNISHMENTS_DROP_MAJOR} 张处分单.`), E.rollPunishment(s.PUNISHMENTS_DROP_MAJOR), dt.ViewMajors()
			}
			static canGraduate() {
				let t = l.getCurrentMajor();
				if (null === t)
					return alert("你要先选择一个专业!!!"), !1;
				if (h.getCurrentPunishments().length > 0)
					return alert("你毕业之前不能有未完成的处分!!"), !1;
				if (f.getCurrentClasses().length > 0)
					return alert("您不能在当前还在进行的课程中毕业。"), !1;
				if (r.currentCredits() < r.requiredCredits())
					return alert("你没有足够的学分!"), !1;
				f.getClassesData();
				let e = f.getCompletedClasses(),
					a = !1,
					s = t.prerequisites.split(" ").filter(t => t);
				for (let t of s)
					e.some(e => e == t) || (a = !0);
				return !0 !== a || (alert("您有未完成的预修课程!"), !1)
			}
			...
			static completeFinalThesis() {
				let t = l.getCompletedMajors(),
					e = l.getCurrentMajorId();
				t.push(e), localStorage.clear(), O.seedData(), localStorage.setItem("completedMajors", JSON.stringify(t)), dt.ViewMajors()
			}
			static failFinalThesis() {
				return alert("你的专业考试不及格，你可以重新考试。已Roll 10个处分!"), E.rollPunishment(10), localStorage.setItem("finalThesisInProgress", "false"), dt.ViewSchedule(), !1
			}
		}
		class Y {
			static runGlobalTimer() {
				setInterval(function() {
					...
					t && (t.forEach(function(e, a) {
						if (e.isPaused || e.isEnded || (e.currentTime = Date.now()), e.currentTime >= e.endTime && (e.isEnded = !0), e.isEnded) {
							t.splice(a, 1);
							let s = new Date(e.startTime).getDate() == k.getLastDate();
							switch (e.sourceType) {
								case "class":
									"daily1" == e.sourceOption || "daily2" == e.sourceOption ? P.attendClass(e.sourceId, s, e.extraCredits) : "exam1" != e.sourceOption && "exam2" != e.sourceOption || P.passClass(e.sourceId, e.extraCredits);
									break;
								case "major":
									dt.ViewEndgame()
							}
						}
					}), b.setTasksTimers(t), T.hasOneDayPassed() && T.passDay())
				}, s.TICK_RATE)
			}
			static pauseTask(t) {
				let e = b.getTasksTimers(),
					a = e.findIndex(e => e.sourceId == t.sourceId);
				1 != t.isPaused && (t.isPaused = !0, t.pauseStart = Date.now(), e[a] = t, b.setTasksTimers(e))
			}
			static resumeTask(t) {
				let e = b.getTasksTimers(),
					a = e.findIndex(e => e.sourceId == t.sourceId);
				...
				s >= 144e5 && (alert("如果你暂停一项任务超过4小时，就会受到惩罚！！！"), Y.failTask(t)), t.pauseStart = null, t.endTime += s, e[a] = t, b.setTasksTimers(e)
			}
			static failTask(t) {
				"class" == t.sourceType ? ("daily1" == t.sourceOption || "daily2" == t.sourceOption ? (alert(`你不完成课业就会受到 ${s.PUNISHMENTS_FAIL_DAILY} 个处分！！！`), E.rollPunishment(s.PUNISHMENTS_FAIL_DAILY)) : "exam1" != t.sourceOption && "exam2" != t.sourceOption || (alert(`任务失败将会受到 ${s.PUNISHMENTS_FAIL_EXAM} punishments for 个处分！！！`), E.rollPunishment(s.PUNISHMENTS_FAIL_EXAM)), b.removeTaskTimer(t), P.failClassTask(t)) : "major" == t.sourceType && (b.removeTaskTimer(t), F.failFinalThesis()), dt.ViewSchedule()
			}
			static increaseTaskTime(t, e) {
				let a = b.getTasksTimers(),
					s = a.findIndex(e => e.sourceId == t);
				s >= 0 && (a[s].endTime += e, b.setTasksTimers(a))
			}
			...
			static punishTask(t) {
				if ("major" == t.sourceType)
					if (3 == t.sourceId) {
						let e = 0;
						switch (t.sourceOption) {
							case "exam1":
								console.log("4days"), e = 3456e5, Y.increaseTaskTime(objectId, e), alert("你的时间增加了4天！！！");
								break;
							case "exam2":
								e = 2592e5, Y.increaseTaskTime(objectId, e), alert("你的时间增加了3天！！！");
								break;
							case "exam3":
								e = 1728e5, Y.increaseTaskTime(objectId, e), alert("你的时间增加了2天！！！")
						}
					} else
						6 != t.sourceId && 7 != t.sourceId || "exam1" == t.sourceOption && E.rollPunishment(1)
			}
			static calculateTaskBonusPoints(t) {
				...
				for (let r of s) {
					...
					(t.some(t => s.indexOf(t) >= 0) || s.some(t => "all" == t)) && (1 == r.perk1 && a++, 1 == r.perk2 && a++)
				}
				return Number(a)
			}
		}
		class V {
			static rollRoullete() {
				...
				let e = Object.keys(t).length,
					a = m.generateRandomIndex(e) + 1,
					s = t[a];
				return C.setRolledToday(!0), C.setLastResult(a), 9 == a && E.rollPunishment(1), s
			}
			static resetRoullete() {
				localStorage.removeItem("lastRouletteResult"), localStorage.removeItem("rouletteRolledToday")
			}
		}
		class q {
			static activateClubPerk(t, e) {
				let a = p.getClubById(t),
					r = g.getActiveClubPerks(),
					i = r.findIndex(e => e.sourceId == t),
					o = r[i];
				if (1 == a.tier) {
					switch (e) {
						case 1:
							o.perk1 = !o.perk1, 1 == o.perk1 ? g.increaseActivePerksNum() : g.decreaseActivePerksNum();
							break;
						case 2:
							o.perk2 = !o.perk2, 1 == o.perk2 ? g.increaseActivePerksNum() : g.decreaseActivePerksNum()
					} - 1 == i ? r.push(o) : r[i] = o;
					let t = g.getActivePerksNum(),
						a = g.getMaxActivePerks();
					if (t > s.MAX_PERKS)
						return alert(`你不能激活超过 ${a} 个奖励！!`), void localStorage.setItem("activePerksNum", a);
					g.setActivePerks(r), S.calculateFinalTaskMultiplier()
				} else if (2 == a.tier) {
					switch (e) {
						case 1:
							if (1 == o.perk1)
								return void alert("奖励已经激活");
							o.perk1 = !0, g.increaseActivePerksNum();
							break;
						case 2:
							if (1 == o.perk2)
								return void alert("奖励已经激活");
							o.perk2 = !0, g.increaseActivePerksNum()
					} - 1 == i ? r.push(o) : r[i] = o;
					let t = g.getActivePerksNum(),
						a = g.getMaxActivePerks();
					if (t > s.MAX_PERKS)
						return alert(`你不能激活超过 ${a}  个奖励!`), void localStorage.setItem("activePerksNum", a);
					g.setActivePerks(r), 1 == e ? S.calculateFinalTaskMultiplier() : I.calculateClubSkips()
				}
				"Experimental club" == a.name && E.rollPunishment(1), 10 == a.id && v.increaseRequiredCredits(s.ELITE_STUDENTS_CREDITS), dt.RefreshView()
			}
			static activatePartnerPerk(t, e) {
				let a = g.getActivePartnerPerks(),
					...
					r = a[s];
				if (12 == t) {
					if (0 != f.getAttendedClassesToday().length)
						return void alert("你今天已经上了一些课，不能再用这个奖励了！");
					if (!C.isRouletteRolledToday())
						return void alert("你今天没有用过性高潮轮盘，请随机完后再试一次。")
				}
				switch (e) {
					case 1:
						r.perk1 = !r.perk1;
					...
					case 2:
						r.perk2 = !r.perk2
				} - 1 == s ? a.push(r) : a[s] = r, g.setActivePartnerPerks(a), 12 == t && V.resetRoullete(), S.calculateFinalTaskMultiplier(), dt.RefreshView()
			}
		}
		class _ {
			static view(t) {
				_.LoadHtml(), _.LoadData()
			}
			static LoadHtml() {
			...
			static LoadData() {
				let t = l.getCurrentMajor(),
					...
					a = h.getCurrentPunishments(),
					i = f.getTodayClasses(),
					o = f.getAttendedClasses(),
					n = p.getClubsData(),
					u = p.getActiveClubs(),
					c = y.getPartnersData(),
					m = y.getActivePartners();
				! function() {
					let t, a = (new Date).setHours(0, 0, 0, 0) + 864e5,
						r = 1e3,
						i = 60 * r,
						o = 60 * i,
						l = 24 * o;
					t = setInterval(function() {
						let s = new Date,
							n = a - s;
						if (n < 0)
							return clearInterval(t), void(document.getElementById("countdown").innerHTML = "过期!");
						let u = Math.floor(n % l / o),
							d = Math.floor(n % o / i),
							c = Math.floor(n % i / r);
						try {
							document.getElementById("countdown").innerHTML = u + "小时 ", document.getElementById("countdown").innerHTML += d + "分钟 ", document.getElementById("countdown").innerHTML += c + "秒 "
						} catch (t) {}
						(e = b.getTasksTimers()).forEach(function(t) {
							let e = `${t.sourceType}${t.sourceId}`,
								a = x.dateObjectToHumanTime(t.endTime - t.currentTime);
							t.isPaused ? $(`#${e}`).text(`活动任务: ${a} 暂停`) : t.isEnded ? $(`#${e}`).text(`活动任务:: ${a} 结束`) : $(`#${e}`).text(`活动任务:: ${a} 剩余时间`)
						})
					}, s.TICK_RATE)
				}
				(), $("#dayToday").text(r.todayName()), null !== t ? $("#major-not-signed-up").hide() : $("#schedule-page-content").hide(),
					function() {
						let t = $("#schedule-punishments-container");
						for (let e of a) {
							let a = h.getPunishmentById(e),
								s = d.getImage(a.id, "punishment"),
								r = s.url;
							a = x.entityApplyMultipliersToText(a);
							let i = $('<div class="col-md-6 object-info border border-dark bg-light">'),
								o = $('<div class="col col-4">'),
								l = $('<div class="col col-7">');
							...
							}))), i.append($('<div class="row">').append(o).append(l)), t.append(i)
						}
					}
					(),
					function() {
						...
						for (let s of i) {
							let i = f.getClassById(s),
								l = d.getImage(i.id, "class"),
								n = l.url,
								u = Y.calculateTaskBonusPoints(i.tags),
								c = f.getClassDailyTaskcredits(i) + u,
								h = r.classExamcredits(i) + u,
								g = o.find(t => t == s),
								m = a.length > 0;
							i = x.entityApplyMultipliersToText(i);
							let p = $('<div class="col-md-6 object-info border border-dark bg-light">'),
								y = $('<div class="col col-4">'),
								b = $('<div class="col col-7">');
							...
							if (w) {
								...
								b.append($(`<h5 class="text-left">已激活任务 - ${t}</h5>`)).append($(`<p class="text-left">${w.description}</p>`)), b.append($('<button class="btn btn-warning btn-sm">暂停</button>').on("click", Y.pauseTask.bind(this, w))), b.append($('<button class="btn btn-success btn-sm">恢复</button>').on("click", Y.resumeTask.bind(this, w))), b.append($('<button class="btn btn-dark btn-sm">惩罚</button>').on("click", Y.punishTask.bind(this, w))), b.append($('<button class="btn btn-danger btn-sm">失败</button>').on("click", Y.failTask.bind(this, w)))
							} else
								b.append($('<h5 class="text-left">').text("完成任务可获得: (" + c + " 学分)")).append($('<p class="text-left">').append($('<button class="btn btn-primary btn-sm">选项 1</button>').on("click", function() {
									...
									dt.ViewTask(t)
								})).append(`${i.daily2}`)), b.append($('<h5 class="text-left">').text("完成考试可获得: (" + h + " 学分)")), g && !m ? b.append($('<p class="text-left">').append($('<button class="btn btn-primary btn-sm">考试 1</button>').on("click", function() {
									let t = {
										entityId: i.id,
										entityType: "class",
										entityOption: "exam1"
									...
									dt.ViewTask(t)
								})).append(`${i.exam2}`)) : (y.append($("<p>至少参加一次课程，并完成你的惩罚才会解锁考试。</p>")), b.append($('<p class="text-left">').append($('<button class="btn btn-primary btn-sm disabled">考试 1</button>')).append(`${i.exam1}`)).append($('<p class="text-left">').append($('<button class="btn btn-primary btn-sm disabled">考试 2</button>')).append(`${i.exam2}`)));
							b.append($(`<div class="lead" id="class${i.id}">`).text("")), p.append($('<div class="row">').append(y).append(b)), t.append(p)
						}
					}
					(),
					function() {
						...
						for (let e of m) {
							let a = c[e],
								s = d.getImage(a.id, "partner"),
								r = s.url,
								i = $('<div class="" id="clubButtons">'),
								o = $('<div class="col-md-6 object-info border border-dark bg-light">'),
								l = $('<div class="col col-4">'),
								n = $('<div class="col col-7">');
							l.append($(`<img class="img-fluid card-img-top hoverable" src="${r}.webp" onerror="this.onerror=null; this.src='${r}.jpg'">`).on("click", function() {
								...
								dt.ViewPartner(t)
							})).append($(`<h6 class="text-center">${a.name}</h6>`)), n.append($('<p class="text-left">').text("奖励 1: " + a.perk1)).append($('<p class="text-left">').text("社团活动任务 1: " + a.job1)).append($('<p class="text-left">').text("奖励 2: " + a.perk2)).append($('<p class="text-left">').text("社团活动任务 2: " + a.job2)).append(i);
							let u = g.getActivePartnerPerks(),
								h = u.findIndex(t => t.sourceId == e);
							0 == u[h].perk1 ? i.append($('<button class="btn btn-success btn-sm btn-margin">选择奖励 1</button>').on("click", q.activatePartnerPerk.bind(this, a.id, 1))) : i.append($('<button class="btn btn-danger btn-sm btn-margin">已激活奖励</button>')), 0 == u[h].perk2 ? i.append($('<button class="btn btn-success btn-sm btn-margin">选择奖励 2</button>').on("click", q.activatePartnerPerk.bind(this, a.id, 2))) : i.append($('<button class="btn btn-danger btn-sm btn-margin">已激活奖励</button>')), o.append($('<div class="row">').append(l).append(n)), t.append(o)
						}
						for (let e of u) {
							let a = n[e],
								s = d.getImage(a.id, "club"),
								r = s.url,
								i = $('<div class="" id="clubButtons">'),
								o = $('<div class="col-md-6 object-info border border-dark bg-light">'),
								l = $('<div class="col col-4">'),
								u = $('<div class="col col-7">');
							l.append($(`<img class="img-fluid card-img-top hoverable" src="${r}.webp" onerror="this.onerror=null; this.src='${r}.jpg'">`).on("click", function() {
								let t = {
									entityId: e
								};
								dt.ViewClub(t)
							})).append($(`<h6 class="text-center">${a.name}</h6>`)), u.append($('<p class="text-left">').text("奖励 1: " + a.perk1)).append($('<p class="text-left">').text("任务 1: " + a.job1)).append($('<p class="text-left">').text("奖励 2: " + a.perk2)).append($('<p class="text-left">').text("任务 2: " + a.job2)).append(i);
							let c = g.getActiveClubPerks(),
								h = c.findIndex(t => t.sourceId == e);
							0 == c[h].perk1 ? i.append($('<button class="btn btn-success btn-sm btn-margin">选择奖励 1</button>').on("click", q.activateClubPerk.bind(this, a.id, 1))) : i.append($('<button class="btn btn-danger btn-sm btn-margin">取消奖励 1</button>').on("click", q.activateClubPerk.bind(this, a.id, 1))), 0 == c[h].perk2 ? i.append($('<button class="btn btn-success btn-sm btn-margin">选择奖励 2</button>').on("click", q.activateClubPerk.bind(this, a.id, 2))) : i.append($('<button class="btn btn-danger btn-sm btn-margin">取消奖励 2</button>').on("click", q.activateClubPerk.bind(this, a.id, 2))), o.append($('<div class="row">').append(l).append(u)), t.append(o)
						}
					}
					(), $("#classSkipsAvailable").text(f.getClassSkipsAvailable()),
					function() {
						let t = S.getFinalTaskMultiplier(),
							e = Math.round(100 * t - 100).toString() + "%";
						$("#taskRequirementsMultiplier").text(e)
					}
					(),
					function() {
						let t = $("#schedule-table-container"),
							e = f.getCurrentClasses().sort((t, e) => t - e),
							a = $("<td>"),
							s = $("<td>"),
							r = $("<td>"),
							i = $("<td>"),
						...
						n.append($("<thead>").append($("<tr>").append($('<th scope="col">').text("星期一")).append($('<th scope="col">').text("星期二")).append($('<th scope="col">').text("星期三")).append($('<th scope="col">').text("星期四")).append($('<th scope="col">').text("星期五")))).append($("<tbody>").append($("<tr>").append(a).append(s).append(r).append(i).append(o))), l.append(n), t.append(l)
					}
					()
			}
		}
		class H {
			...
			static LoadData() {
				if (0 == function() {
						let t = l.getCurrentMajor();
						null != t && $("#major-not-signed-up").hide();
						if (null == t)
							return $("#progress-page-content").hide(), !1;
						let e = $('<div id="roulette-result">'),
							a = d.getImage(t.id, "major").url,
							s = $('<div class="major-info">').append($('<div class="row">').append($('<div class="col-md-6">').append($('<div class="row pt-2">').append($('<div class="col">').append($(`<img class="img-fluid" style="max-height: 300px" src="${a}.webp" onerror="this.onerror=null; this.src='${a}.jpg'">`)).on("click", function() {
								let e = {
									entityId: t.id
								};
								dt.ViewMajor(e)
						...
						if ($("#progress-active-major").append(s), C.isRouletteRolledToday()) {
				...
				! function() {
					let t = f.getCurrentClasses(),
						e = t.sort((t, e) => t - e),
						a = $("#progress-active-classes"),
						r = $('<div class="row">');
					for (let t of e) {
						let e = f.getClassById(t),
							a = $('<div class="col-auto">'),
							s = d.getImage(e.id, "class"),
							i = s.url,
							o = $('<div class="card border-dark" >');
						o.append($(`<img class="card-img-top hoverable" src="${i}.webp" onerror="this.onerror=null; this.src='${i}.jpg'">`)).on("click", function() {
							let t = {
								entityId: e.id
							};
							dt.ViewClass(t)
						}).append($('<h4 class="card-title">').text(e.name).append($("<h5>").text(e.tier.charAt(0).toUpperCase() + e.tier.slice(1)))), r.append(a.append(o))
					}
					a.append(r), $("#currentClassesNum").text(t.length), $("#maxCurrentClasses").text(s.MAX_ACTIVE_CLASSES)
				}
				(),
				function() {
					let e = l.getCurrentMajor(),
						a = m.traversePrerequisites(e),
						s = f.getCompletedClasses(),
						r = $("#progress-mandatory-classes"),
						i = $('<div class="row">');
					for (let e of a) {
						let a = t[e],
							r = $('<div class="col-auto">'),
							o = d.getImage(a.id, "class"),
							l = o.url,
							n = $('<div class="card border-dark" >');
						n.append($(`<img class="card-img-top hoverable" src="${l}.webp" onerror="this.onerror=null; this.src='${l}.jpg'">`)).on("click", function() {
							let t = {
								entityId: a.id
							};
							dt.ViewClass(t)
						}).append($('<h4 class="card-title">').text(a.name).append($("<h5>").text(a.tier.charAt(0).toUpperCase() + a.tier.slice(1)))), s.find(t => t == e) && n.append($('<a href="" class="indicator-complete">Completed</a>')), i.append(r.append(n))
					}
					r.append(i)
				}
				(),
				function() {
					let e = f.getCompletedClasses(),
						a = e.sort((t, e) => t - e),
						s = $("#progress-completed-classes"),
						r = $('<div class="row">');
					e.length <= 0 && s.append(r.append($('<div class="col">').append($("<h4>").text("无"))));
					for (let e of a) {
						let a = t[e],
							s = $('<div class="col-auto">'),
							i = d.getImage(a.id, "class"),
							o = i.url,
							l = $('<div class="card border-dark" >');
						l.append($(`<img class="card-img-top hoverable" src="${o}.webp" onerror="this.onerror=null; this.src='${o}.jpg'">`)).on("click", function() {
							let t = {
								entityId: a.id
							};
							dt.ViewClass(t)
						}).append($('<h4 class="card-title">').text(a.name).append($("<h5>").text(a.tier.charAt(0).toUpperCase() + a.tier.slice(1)))), r.append(s.append(l))
					}
					s.append(r)
				}
				(),
				function() {
					let t = h.getCurrentPunishments(),
						e = $("#progressLoadPunishments"),
						s = $('<div class="row">');
					for (let e of t) {
						let t = a[e],
							r = $('<div class="col-auto">'),
							i = $('<div class="card" >'),
							o = d.getImage(t.id, "punishment"),
							l = o.url;
						i.append($(`<img class="card-img-top hoverable" src="${l}.webp" onerror="this.onerror=null; this.src='${l}.jpg'">`)).on("click", function() {
							...
							dt.ViewPunishment(e)
						}).append($('<h5 class="card-title">').text(t.name)), $(s).append(r.append(i))
					}
					e.append(s), $("#currentPunishmentsNum").text(t.length), $("#maxPunishmentsNum").text(h.getMaxPunishments())
				}
				(),
				function() {
					let t = p.getActiveClubs(),
					...
					for (let a of t) {
						...
						i.append($(`<img class="card-img-top hoverable" src="${l}.webp" onerror="this.onerror=null; this.src='${l}.jpg'">`)).on("click", function() {
							...
							dt.ViewClub(e)
						}).append($('<h5 class="card-title">').text(t.name)), $(r).append(s.append(i))
					}
					a.append(r), $("#currentClubsNum").text(t.length), $("#maxClubsNum").text(s.MAX_CLUBS)
				}
				(),
				function() {
					let e = f.getCompletedClasses(),
						...
						r = 0,
						i = 0,
						o = JSON.parse(localStorage.getItem("advancedClassesRequired"));
					for (let o of e) {
						let e = t[o];
						"1" == e.id.charAt(0) ? a++ : "2" == e.id.charAt(0) ? s++ : "3" == e.id.charAt(0) ? r++ : "4" == e.id.charAt(0) && i++
					}
					$("#completedBeginnerClassesNum").text(a), $("#completedIntermediateClassesNum").text(s), $("#completedAdvancedClassesNum").text(r), $("#maxAdvancedClassesNum").text(o), $("#completedMasterClassesNum").text(i);
				...
				function() {
					let t = $(".progressButtonGraduate"),
						e = $('<button class="btn btn-success">').text("Graduate!").on("click", function() {
							F.choseFinalThesis()
						});
					t.append(e)
				}
		...
		class W {
			...
			static LoadData() {
				$(".creditsToGrad").text(s.REQUIRED_CREDITS_GRADUATION), $("#maxClasses").text(s.MAX_ACTIVE_CLASSES), $("#maxPunishments").text(s.MAX_PUNISHMENTS)
			}
		}
		class z {
			static resetMajor() {
				let t = l.getCompletedMajors();
				localStorage.clear(), localStorage.setItem("completedMajors", JSON.stringify(t)), alert("Major progress has been reset"), location.reload()
			}
			static resetGame() {
				localStorage.clear(), alert("Game progress has been reset"), location.reload()
			}
		}
		class B {
		...
		class J {
			...
			static LoadData() {
				$("#resetButtons").append($('<div class="row border settings-row">').append($('<div class="col">').text("有课程缺少吗?点击这里更新你的课程表。")).append($('<div class="col">').append($('<button class="btn btn-primary btn-margin">修复一下</button>').on("click", function() {
					P.calculateTodayClasses(), alert("Updated today's schedule!")
					...
					confirm("你想重置你的主要进度吗?") && z.resetMajor()
					...
					O.exportLocStorage()
				})))), document.getElementById("file-input").addEventListener("change", O.importLocStorage, !1), j.isEasyModeEnabled() ? $("#easymode-button").append($('<button class="btn btn-success btn-margin">启用</button>').on("click", function() {
					j.switchEasyMode()
				})) : $("#easymode-button").append($('<button class="btn btn-danger btn-margin">禁用</button>').on("click", function() {
					j.switchEasyMode()
				})), h.IsUnlockedHardcorePunishments() ? $("#hardcorePunishments-button").append($('<button class="btn btn-success btn-margin">禁用</button>').on("click", function() {
					...
					E.switchHardcorePunishments()
				})), B.isCommunityContentEnabled() ? $("#communityContent-button").append($('<button class="btn btn-success btn-margin disabled">启用</button>').on("click", function() {})) : $("#communityContent-button").append($('<button class="btn btn-danger btn-margin">禁用</button>').on("click", function() {}))
			}
		}
		class G {
			static view() {
				G.LoadHtml(), G.LoadData()
			}
			static LoadHtml() {
			...
			static LoadData() {
				...
				$("#upload-progress-button").append($('<button class="btn-success">提交</button>').on("click", A.uploadProgressData.bind(this))), t.append($('<button type="button" class="btn btn-primary btn-sm btn-margin">All</button>').on("click", G.viewAll.bind(this)));
			...
			static viewAll() {
				$.ajax({
					...
					$("#ranking-title").text("Ranking - All"), $("#ranking-table").empty();
					...
					a.append(s), $("#ranking-table").append(a)
				}).catch(m.handleAjaxError)
			}
			static viewByMajor(t) {
				...
				$.ajax({
					...
					$("#ranking-title").text(`Ranking - ${e}`), $("#ranking-table").empty();
					...
					s.append(r), $("#ranking-table").append(s)
				}).catch(m.handleAjaxError)
			}
		}
		class K {
			static view(t) {
				K.LoadHtml(), K.LoadData()
			}
			static LoadHtml() {
			...
			static LoadData() {
				let t = p.getClubsData(),
					e = y.getPartnersData(),
					a = y.getActivePartners(),
					s = $("#partners-container"),
					r = $("#normal-clubs-container"),
					i = $("#elite-clubs-container");
				for (let t in e) {
					let r = e[t];
					if (r.community)
						continue;
					...
					o.append($(`<img class="card-img-top hoverable" src="${l}.webp" onerror="this.onerror=null; this.src='${l}.jpg'" alt="${r.name}">`)).on("click", function() {
						...
						dt.ViewPartner(e)
					}), n && o.append($('<div class="indicator-active">姬友已激活</div>')), o.append($('<h4 class="card-title">').text(r.name).append($(`<h6>${r.name2}</h6>`))), s.append(i.append(o))
				}
				...
				for (let e in t) {
					...
					l.append($(`<img class="card-img-top hoverable" src="${n}.webp" onerror="this.onerror=null; this.src='${n}.jpg'" alt="${a.name}">`)).on("click", function() {
						...
						dt.ViewClub(t)
					}), l.append($('<h4 class="card-title">').text(a.name)), a.tier > 1 && !A.unlockedEliteClubs() ? l.append($('<div class="indicator-locked">未解锁！！精英社团100学分解锁！</div>')) : u && l.append($('<div class="indicator-active">社团已激活</div>')), "1" == a.tier ? r.append(s.append(l)) : "2" == a.tier && i.append(s.append(l))
				}
			}
		}
		class X {
			static view(t) {
				X.LoadHtml(), X.LoadData()
			}
			static LoadHtml() {
			...
			static LoadData() {
				...
				let t = h.getPunishmentsData(),
					e = h.getCurrentPunishments(),
					a = $("#light-punishments-container"),
					s = $("#heavy-punishments-container"),
					r = $("#hardcore-punishments-container");
				for (let i in t) {
					let o = t[i];
					if (o.community)
						continue;
					let l = $('<div class="col-auto">'),
						n = $('<div class="card" >'),
						u = d.getImage(o.id, "punishment").url,
						c = e.some(t => t == i);
					n.append($(`<img class="card-img-top hoverable" src="${u}.webp" onerror="this.onerror=null; this.src='${u}.jpg'" alt="${o.name}">`)).on("click", function() {
						...
						dt.ViewPunishment(t)
					}), n.append($('<h5 class="card-title">').text(o.name)), (3 != o.tier || A.unlockedHardPunishments() && h.IsUnlockedHardcorePunishments()) && (2 != o.tier || A.unlockedHardPunishments()) ? c && n.append($('<div class="indicator-active">惩罚已激活</div>')) : n.append($('<div class="indicator-locked">未解锁！！100学分解锁！</div>')), "1" == o.tier ? a.append(l.append(n)) : "2" == o.tier ? s.append(l.append(n)) : "3" == o.tier && r.append(l.append(n))
				}
			}
		}
		class Z {
			static view() {
				Z.LoadHtml(), Z.LoadData()
			}
			static LoadHtml() {
		...
		class Q {
			...
			static viewLegacy(t) {
				...
				history.replaceState("", "", "./"), Q.LoadHtml(), Q.LoadData(e)
			}
			static LoadHtml() {
			...
			static LoadData(t) {
				let e = t.entityId,
					a = b.getTasksTimers().find(t => t.sourceId == e),
					s = f.getClassesData(),
					i = s[e],
					o = f.getCurrentClasses().find(t => t == e),
					l = f.getCompletedClasses().find(t => t == e),
					n = f.getAttendedClasses().find(t => t == e),
					u = h.getActivePunishmentsNum() > 0,
					c = f.getTodayClasses().find(t => t == e),
					g = (i = x.entityFixTextNumbers(i)).days.split(" ").filter(t => t),
					m = r.weekdays(),
					p = [];
				...
				let y = p.join(", "),
					w = i.prerequisites.split(" ").filter(t => t),
					U = $("<h5>").text("先修科目: 无");
				if (w.length > 0) {
					U.text("先修科目:  ");
					for (let t of w) {
						let e = s[t],
							a = $('<a class="text-primary">').text(`${e.name}, `).on("click", function() {
								let e = {
									entityId: t,
									entityType: "class"
								};
				...
				v.append($(`<img class="img-fluid viewObject-img hoverable" src="${k}.webp" onerror="this.onerror=null; this.src='${k}.jpg'" alt="${i.name}">`).on("click", function() {
					dt.RefreshView()
				})), v.append($("<h2>").text(i.name)).append($("<h5>").text("上课日期:  " + y)).append($("<h5>").append(U)).append($("<p>").text(i.description)), v.append($("<hr>")).append($("<h5>日常任务选项</h5>")).append($("<p>").append($("<b>").text("选项 1: ")).append($("<span>").text(i.daily1))).append($("<p>").append($("<b>").text("选项 2: ")).append($("<span>").text(i.daily2))), c ? a ? v.append($('<button class="btn btn-dark">这个课程有一个正在运行的任务/计时器。</button>').on("click", function() {
					let t = {
						entityId: e,
						entityType: "class",
					...
					dt.ViewTask(t)
				})) : o && v.append($('<button class="btn btn-success btn-margin">选项 1</button>').on("click", function() {
					let t = {
						entityId: e,
						entityType: "class",
						entityOption: "daily1"
					...
					dt.ViewTask(t)
				})) : v.append($("<h6>今天没有这门课</h6>")), v.append($("<hr>")).append($("<h5>考试选项</h5>")).append($("<p>").append($("<b>").text("选项 1: ")).append($("<span>").text(i.exam1))).append($("<p>").append($("<b>").text("选项 2: ")).append($("<span>").text(i.exam2))), c ? a ? v.append($('<button class="btn btn-dark">这个课程有一个正在运行的任务/计时器。</button>').on("click", function() {
					let t = {
						entityId: e,
						entityType: "class",
						entityOption: a.sourceOption
					...
					dt.ViewTask(t)
				})) : u ? v.append($("<h6>你要先完成你的处分来解锁考试。</h6>")) : n ? o && v.append($('<button class="btn btn-success btn-margin">考试 1</button>').on("click", function() {
					let t = {
						entityId: e,
						entityType: "class",
						entityOption: "exam1"
					...
					dt.ViewTask(t)
				})) : v.append($("<h6>至少参加一次课程来解锁考试。</h6>")) : v.append($("<h6>今天没有这门课。</h6>")), v.append($("<hr>")), o ? v.append($('<button class="btn btn-danger">Drop class</button>').on("click", P.leaveClass.bind(this, i.id))) : l ? v.append($('<button class="btn btn-primary">完成</button>')) : v.append($('<button class="btn btn-success">选择此课程</button>').on("click", P.joinClass.bind(this, i.id))), v.append($("<hr>")), v.append($('<small class="text-sm-center">这里没有应用任何补充说明。</small>'))
			}
		}
		class tt {
			static view(t) {
				tt.LoadHtml(), tt.LoadData(t)
			}
			static LoadHtml() {
			...
			static LoadData(t) {
				let e = t.entityId,
					a = y.getPartnersData(),
					s = y.getActivePartners(),
					r = a[e],
					i = $("#object-container"),
					o = d.getImage(e, "partner").url;
				i.append($('<div class="row">').append($('<div class="col">').append($(`<img class="img-fluid viewObject-img hoverable" src="${o}.webp" onerror="this.onerror=null; this.src='${o}.jpg'" alt="${r.name}">`).on("click", function() {
					dt.RefreshView()
				})))).append($('<div class="row">').append($('<div class="col text-center">').append($("<h2>").text(r.name)).append($("<h5>").text(r.name2)).append($("<p>").text(r.description)))).append($('<div class="row">').append($('<div class="col">').append($("<h6>").text("奖励:")).append($("<p>").append($("<b>").text("奖励 1: ")).append($("<span>").text(r.perk1))).append($("<p>").append($("<b>").text("奖励 2: ")).append($("<span>").text(r.perk2)))).append($('<div class="col">').append($("<h6>").text("社团活动任务:")).append($("<p>").append($("<b>").text("社团任务 1: ")).append($("<span>").text(r.job1))).append($("<p>").append($("<b>").text("社团任务 2: ")).append($("<span>").text(r.job2))))), s.includes(e) ? i.append($('<div class="row">').append($('<div class="col">').append($('<button class="btn btn-danger">退出社团</a>').on("click", function() {
					N.kickPartner(e)
		...
		class et {
			...
			static LoadData(t) {
				let e = t.entityId,
					a = b.getTasksTimers().find(t => t.sourceId == e && "major" == t.sourceType);
				if (a) {
					let t = {
						entityId: e,
						entityType: "major",
				...
				n.append($(`<img class="img-fluid viewObject-img hoverable" src="${u}.webp" onerror="this.onerror=null; this.src='${u}.jpg'" alt="${s.name}">`).on("click", function() {
					dt.RefreshView()
				})).append($("<h2>").text(s.name)).append($("<h5>").append(o)).append($("<p>").text(s.description)).append($("<div\nclass=\"alert\nalert-danger\"\nrole=\"alert\">").text("安全警告：" + s.safety_alert)), n.append($("<hr>")).append($("<h5>专业毕业考:</h5>")).append($("<p>").append($("<b>").text("专业考试 1: ")).append($("<span>").text(s.exam1))).append($("<p>").append($("<b>").text("专业考试 2: ")).append($("<span>").text(s.exam2))).append($("<p>").append($("<b>").text("专业考试 3: ")).append($("<span>").text(s.exam3))), t.unlocked && n.append($("<hr>")).append($('<button class="btn btn-success btn-margin">专业考试  1</button>').on("click", function() {
					let t = {
						entityId: s.id,
						entityType: "major",
						entityOption: "exam1"
				...
				l.getCompletedMajors().find(t => t == e) ? n.append($('<button class="btn btn-primary">Completed</button>')) : c ? c.id == e ? n.append($('<button href="" class="btn btn-danger">专业退选</button>').on("click", function() {
					F.dropMajor(e)
				})) : c.id != e && n.append($('<button class="btn btn-secondary">你已经加入了另一个专业。</button>')) : n.append($('<button class="btn btn-success">选择此专业</button>').on("click", function() {
					F.signMajor(e)
				}))
			}
		}
		class at {
			...
			static LoadData(t) {
				let e = p.getClubsData(),
					...
					r = e[s],
					i = $("#object-container"),
					o = d.getImage(r.id, "club").url;
				i.append($('<div class="row">').append($('<div class="col">').append($(`<img class="img-fluid viewObject-img hoverable" src="${o}.webp" onerror="this.onerror=null; this.src='${o}.jpg'" alt="${r.name}">">`).on("click", function() {
					dt.RefreshView()
				})))).append($('<div class="row">').append($('<div class="col text-center">').append($("<h2>").text(r.name)).append($("<p>").text(r.description)))).append($('<div class="row">').append($('<div class="col">').append($("<h6>").text("社团奖励:")).append($("<p>").append($("<b>").text("奖励 1: ")).append($("<span>").text(r.perk1))).append($("<p>").append($("<b>").text("奖励 2: ")).append($("<span>").text(r.perk2)))).append($('<div class="col">').append($("<h6>").text("社团奖励任务:")).append($("<p>").append($("<b>").text("社团任务 1: ")).append($("<span>").text(r.job1))).append($("<p>").append($("<b>").text("社团任务 2: ")).append($("<span>").text(r.job2))))), a.includes(s) ? i.append($('<div class="row">').append($('<div class="col">').append($('<button class="btn btn-danger">离开</a>').on("click", I.leaveClub.bind(this, r))))) : i.append($('<div class="row">').append($('<div class="col">').append($('<button class="btn btn-success">加入社团</button>').on("click", I.joinClub.bind(this, r.id)))))
			}
		}
		class st {
			static view(t) {
				st.LoadHtml(), st.LoadData(t)
			}
			static LoadHtml() {
				$("main").html('<div id="object-container" class="container text-center">\n    </div>')
			}
			static LoadData(t) {
				...
				console.log(e), e = x.entityFixTextNumbers(e);
				let a = $("#object-container"),
					s = d.getImage(e.id, "punishment").url;
		...
		class rt {
			constructor(t, e, a, s, r, i, o) {
				this.sourceId = t, this.sourceType = e, this.sourceOption = a, this.description = s, this.extraCredits = o, this.startTime = Date.now(), this.currentTime = r, this.endTime = this.currentTime + i, this.isPaused = !1, this.pauseStart = null, this.pauseEnd = null, this.isEnded = !1
			}
		}
		class it {
		...
		class ot {
			...
			static LoadData(t) {
				let e, a, r = $("#object-container");
				switch (t.entityType) {
					case "major":
						e = d.getImage(t.entityId, "major"), a = l.getMajorsData();
						break;
					case "class":
						e = d.getImage(t.entityId, "class"), a = f.getClassesData();
						break;
					case "club":
						e = d.getImage(t.entityId, "club"), a = p.getClubsData();
						break;
					case "punishment":
						e = d.getImage(t.entityId, "punishment"), a = h.getPunishmentsData();
						break;
					case "career":
						e = d.getImage(t.entityId, "career"), a = it.getCareersData();
						break;
					default:
						return void alert("出问题了，见控制台。")
				}
				let i = e.url,
					o = a[t.entityId];
				r.append($(`<img class="img-fluid viewObject-img" src="${i}.webp" onerror="this.onerror=null; this.src='${i}.jpg'">`)), r.append($("<h2>").text(o.name));
				let n = o[t.entityOption],
					u = x.applyMultipliersToText(n, o.tags);
				r.append($(`<h6 id="object-description">${u}</h6>`));
				let c = x.textToMilliseconds(n);
				"major" != t.entityType && (c = x.applyMultipliersToDuration(c, o.tags));
				...
				let m = $("#task-buttons"),
					y = b.getTasksTimers().find(e => e.sourceId == t.entityId);

				function w(e) {
					m.empty(), m.append($('<button class="btn btn-warning btn-margin">暂停</button>').on("click", Y.pauseTask.bind(this, e))), m.append($('<button class="btn btn-success btn-margin">恢复</button>').on("click", Y.resumeTask.bind(this, e))), m.append($('<button class="btn btn-dark btn-margin">惩罚</button>').on("click", Y.punishTask.bind(this, e))), m.append($('<button class="btn btn-danger btn-margin">失败</button>').on("click", Y.failTask.bind(this, e))), m.append($("<hr>")), l.isFinalThesisInProgress() ? m.append($('<button class="btn btn-dark btn-margin">在你的考试完成之前，你是不允许浏览其他页面！！</button>').on("click", function() {})) : m.append($('<button class="btn btn-primary btn-margin">前往课程表</button>').on("click", function() {
						dt.ViewSchedule()
					...
					let i = setInterval(function() {
						if (!(e = b.getTasksTimers().find(e => e.sourceId == t.entityId))) {
							...
							return m.empty(), "major" == t.entityType ? m.append($('<button class="btn btn-primary">专业考试完成</button>').on("click", function() {
								dt.ViewEndgame()
							})) : "class" == t.entityType && m.append($('<button class="btn btn-primary">任务完成</button>').on("click", function() {
								dt.ViewSchedule()
							})), void clearInterval(i)
						}
						let s = e.endTime - e.currentTime,
							r = x.dateObjectToHumanTime(s);
						if (e.isEnded) {
							document.getElementById("audio");
							m.empty(), "major" == e.sourceType ? m.append($('<button class="btn btn-primary">专业考试完成</button>').on("click", function() {
								dt.ViewEndgame()
							})) : m.append($('<button class="btn btn-primary">任务完成</button>').on("click", function() {
								dt.ViewSchedule()
							})), clearInterval(i)
						} else
							e.isPaused ? $("#timer").text(`${r} - PAUSED`) : $(`#${a}`).text(r)
					}, s.TICK_RATE_FAST);
					if ("major" == i.sourceType) {
						let t = h.getCurrentPunishments();
						for (let e of t) {
							...
							let a = $('<div class="object-info border border-dark bg-light">'),
								s = $('<div class="col col-4">'),
								i = $('<div class="col col-7">');
							s.append($(`<img class="card-img-top img-fluid" src="${t}.webp" onerror="this.onerror=null; this.src='${t}.jpg'">`)), i.append($(`<h6 class="text-center">${e.name}</h6>`)).append($('<p class="text-left">').text(e.description)).append($('<div class="btn-group">').append($('<button class="btn btn-success btn-sm">完成</button>').on("click", E.completePunishment.bind(this, e))).append($('<button class="btn btn-warning btn-sm">重新随机</button>').on("click", E.rerollPunishment.bind(this, e)))), a.append($('<div class="row">').append(s).append(i)), r.append(a)
						}
					}
				}
				y ? w(y) : 0 == c ? (m.append($('<button class="btn btn-success btn-lg btn-margin">完成</button>').on("click", function() {
					let e = new rt(o.id, t.entityType, t.entityOption, u, Date.now(), c, g);
					b.addTaskTimer(e), "major" == e.sourceType && l.setFinalThesisInProgress(!0), w(e)
					...
					b.addTaskTimer(e), "major" == e.sourceType && l.setFinalThesisInProgress(!0), console.log("FAIL"), Y.failTask(o.id, t.entityType, t.entityOption)
		...
		class nt {
			static view(t) {
				nt.LoadHtml(), nt.LoadData(t)
			}
			static LoadHtml() {
				$("main").html('\n        <div class="container text-center" id="object-container">\n    </div><br>\n    <div class="donate text-center">\n    </div>')
			}
			static LoadData(t) {
				localStorage.setItem("graduated", JSON.stringify(!0));
				let e = l.getCurrentMajor(),
					a = f.getCompletedClasses(),
					s = h.getPunishmentsDoneNum(),
					r = $("#object-container"),
					i = `祝贺你，你终于从大学毕业了!这是一个漫长的旅程，我们希望你喜欢它! 您已经完成了 ${a.length} 个课程和忍受了 ${s}次处分。${e.name}已添加到您已完成的专业列表中。你可以选择另一个专业，以进一步增加你未来的职业前景。不要忘记导出您的保存文件并将您的进度提交到排行榜! \n            \n            大学也将感谢你们游玩，因为你们的游玩能帮助的运行和帮助它的发展。\n            \n            愿你在未来的道路上继续取得成功!\n            \n            此致\n            抖喵酱\n            `;
				r.append($('<img class="img-fluid viewObject-img" src="img/graduation.jpg">')), r.append($("<h4>").text(i)), r.append($('<button class="btn btn-success">恭喜你！</button>').on("click", function() {
					console.log("click"), F.completeFinalThesis()
				}))
			}
		}
		class ut {
			static view(t) {
				ut.LoadHtml(), ut.LoadData()
			}
			static LoadHtml() {
			...
			static LoadData() {
				! function() {
					let t = p.getClubsData(),
						e = y.getPartnersData(),
						a = $("#community-clubs-container"),
						s = $("#community-clubs-container"),
						r = $("#community-clubs-container"),
						i = y.getActivePartners();
					for (let t in e) {
						let s = e[t];
						if (1 == s.community) {
							let e = $('<div class="col-auto">'),
								r = $('<div class="card" >'),
								o = d.getImage(s.id, "partner"),
								l = o.url,
								n = i.some(t => t == s.id);
							r.append($(`<img class="card-img-top hoverable" src="${l}.webp" onerror="this.onerror=null; this.src='${l}.jpg'" alt="${s.name}">`)).on("click", function() {
								...
								dt.ViewPartner(e)
							}), n && r.append($('<div class="indicator-active">已激活</div>')), r.append($('<h4 class="card-title">').text(s.name).append($(`<h6>${s.name2}</h6>`))), a.append(e.append(r))
						}
					}
					let o = p.getActiveClubs();
					for (let e in t) {
						...
						if (1 == a.community) {
							...
							i.append($(`<img class="card-img-top hoverable" src="${n}.webp" onerror="this.onerror=null; this.src='${n}.jpg'" alt="${a.name}">`)).on("click", function() {
								...
								dt.ViewClub(t)
							}), i.append($('<h4 class="card-title">').text(a.name)), a.tier > 1 && !A.unlockedEliteClubs() && i.append($('<div class="indicator-locked">未解锁</div>')), u && i.append($('<div class="indicator-active">已激活</div>')), "1" == a.tier ? s.append(t.append(i)) : "2" == a.tier && r.append(t.append(i))
						}
					}
				}
				(),
				function() {
					...
					for (let i in t) {
						...
						if (1 == o.community) {
							let t = !1,
								l = o.prerequisites.split(" ").filter(t => t);
							for (let a of l) {
								let s = e.find(t => t == a);
								s || (t = !0)
							}
							"intermediate" == o.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_INTERMEDIATE ? t = !0 : "advanced" == o.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_ADVANCED ? t = !0 : "master" == o.tier && Number(r.currentCredits()) < s.REQUIRED_CREDITS_UNLOCK_MASTER && (t = !0);
							let n = e.some(t => t == i),
								u = a.some(t => t == i),
								c = $('<div class="col-auto">'),
								h = d.getImage(o.id, "class"),
								g = h.url,
								m = $('<div class="card border-secondary" >');
							m.append($(`<img class="card-img-top hoverable" src="${g}.webp" onerror="this.onerror=null; this.src='${g}.jpg'" alt="${o.name}">`)).on("click", function() {
								...
								dt.ViewClass(t)
							}).append($('<h4 class="card-title">').text(o.name).append($(`<h6>${o.name2}</h6>`))), t ? m.append($('<div class="indicator-locked">未解锁</div>')) : n ? m.append($('<div class="indicator-complete">已完成</div>')) : u && m.append($('<div class="indicator-active">已激活</div>')), $("#community-classes-container").append(c.append(m))
						}
					}
				}
				()
		...
		class dt {
			...
			static ViewIndex(t, e = 0) {
				lt.setView("index"), window.scrollTo(0, e), dt.relaodNavbar(), i.view(t)
			}
			static ViewMajors(t, e = 0) {
				l.isFinalThesisInProgress() ? dt.RedirectToFinalThesis() : (lt.setView("majors"), window.scrollTo(0, e), dt.relaodNavbar(), c.view(t))
			}
			static ViewClasses(t, e = 0) {
				l.isFinalThesisInProgress() ? dt.RedirectToFinalThesis() : (lt.setView("classes"), window.scrollTo(0, e), dt.relaodNavbar(), w.view(t))
			}
			static ViewClubs(t, e = 0) {
				l.isFinalThesisInProgress() ? dt.RedirectToFinalThesis() : (lt.setView("clubs"), window.scrollTo(0, e), dt.relaodNavbar(), K.view(t))
			}
			static ViewPunishments(t, e = 0) {
				l.isFinalThesisInProgress() ? dt.RedirectToFinalThesis() : (lt.setView("punishments"), window.scrollTo(0, e), dt.relaodNavbar(), X.view(t))
			}
			static ViewSchedule(t, e = 0) {
				l.isFinalThesisInProgress() ? dt.RedirectToFinalThesis() : (lt.setView("schedule"), window.scrollTo(0, e), dt.relaodNavbar(), _.view(t))
			}
			static ViewProgress(t, e = 0) {
				l.isFinalThesisInProgress() ? dt.RedirectToFinalThesis() : (lt.setView("progress"), window.scrollTo(0, e), dt.relaodNavbar(), H.view(t))
			}
			static ViewInfo(t, e = 0) {
				lt.setView("info"), window.scrollTo(0, e), dt.relaodNavbar(), W.view(t)
			}
			static ViewSettings(t, e = 0) {
				lt.setView("settings"), window.scrollTo(0, e), dt.relaodNavbar(), J.view(t)
			}
			static ViewRanking(t, e = 0) {
				lt.setView("ranking"), window.scrollTo(0, e), dt.relaodNavbar(), G.view(t)
			}
			static ViewChat(t, e = 0) {
				lt.setView("chat"), window.scrollTo(0, e), dt.relaodNavbar(), Z.view(t)
			}
			static ViewCommunity(t, e = 0) {
				lt.setView("community"), window.scrollTo(0, e), dt.relaodNavbar(), ut.view(t)
			}
			static ViewMajor(t, e = 0) {
				window.scrollTo(0, e), dt.relaodNavbar(), et.view(t)
			}
			static ViewClass(t, e = 0) {
				window.scrollTo(0, e), dt.relaodNavbar(), Q.view(t)
			}
			static ViewPartner(t, e = 0) {
				window.scrollTo(0, e), dt.relaodNavbar(), tt.view(t)
			}
			static ViewClub(t, e = 0) {
				window.scrollTo(0, e), dt.relaodNavbar(), at.view(t)
			}
			static ViewPunishment(t, e = 0) {
				window.scrollTo(0, e), dt.relaodNavbar(), st.view(t)
			}
			static ViewTask(t, e = 0) {
				window.scrollTo(0, e), dt.relaodNavbar(), ot.view(t)
			}
			static RedirectToFinalThesis(t = 0) {
				if (window.scrollTo(0, t), dt.relaodNavbar(), 1 == JSON.parse(localStorage.getItem("graduated")))
					return void nt.view();
				let e = {
					entityType: "major",
			...
			static ViewEndgame(t, e = 0) {
				lt.setView("endgame"), window.scrollTo(0, e), dt.relaodNavbar(), nt.view(t)
			}
			static RefreshView(t) {
				let e = window.scrollY;
				switch (ct.load(), lt.getView()) {
					case "index":
						dt.ViewIndex(t, e);
						break;
					case "majors":
		...
		class ct {
			static load() {
				let t = $("#loadNavbar");
				t.empty(), t.append($('<nav class="navbar navbar-expand-lg navbar-light bg-light">').append($('<nav class="navbar navbar-light bg-light">').append($('<a class="navbar-brand">').append($('<img src="img/logo.png" style="max-height: 30px" class="d-inline-block align-top" alt="">')).on("click", function() {
					dt.RefreshView()
					...
					dt.ViewSettings()
				})))))), 1 == JSON.parse(localStorage.getItem("debug")) && $(".navbar-nav").append($('<li class="nav-item">').append($('<button class="nav-link btn btn-primary">PassDay</button>').on("click", function() {
					T.passDay()
				})))
			}
		}
		window.onload = function() {
			try {
				null == localStorage.getItem("firstRun") && O.seedData(), M.getGameVersion() != s.CURRENT_VERSION && (console.log("updating game"), D.updateGame()), ct.load(), class {
					static load() {
						$("footer").append($('<div class="footer-container text-center" style="height: 200px">').append($('\n         <div class="donate">\n            <form action="https://afdian.net/@doumiaojiang" method="post" target="_top">\n                <input type="hidden" name="cmd" value="_s-xclick" />\n                <input type="hidden" name="hosted_button_id" value="ELWBWSLCDAAU8" />\n                <input type="image" src="https://sissy.game/sissy-university/img/paypal-banner.png" border="0" name="submit" title="爱发电 - 将创作的自由，还给创作者!" alt="抖喵酱爱发电链接" />\n            </form>\n        </div>`)')).append($('<a class="footer-img" href="https://shop575649948.m.taobao.com">').append($('<img src="https://sissy.game/sissy-university/img/patreon-banner.jpg"  alt="抖喵家淘宝店">'))))
					}
				}.load(), Y.runGlobalTimer();
				...
				switch (a.htmlFile) {
					...
					case "index.html":
						...
						break;
					case "majors.html":
						history.pushState(null, "", "./"), dt.ViewMajors(a);
						break;
					case "classes.html":
						history.pushState(null, "", "./"), dt.ViewClasses(a);
						break;
					case "clubs.html":
						history.pushState(null, "", "./"), dt.ViewClubs(a);
						break;
					...
					case "major.html":
						t = {
							entityType: "major",
							entityId: a.majorId
						}, history.pushState(null, "", "./"), dt.ViewMajor(t);
						break;
					case "class.html":
						t = {
							entityType: "class",
							entityId: a.classId
						}, history.pushState(null, "", "./"), dt.ViewClass(t);
						break;
					case "club.html":
						t = {
							entityType: "club",
							entityId: a.clubId
						}, history.pushState(null, "", "./"), dt.ViewClub(t);
						break;
					case "partner.html":
						t = {
							entityType: "partner",
							entityId: a.partnerId
						}, history.pushState(null, "", "./"), dt.ViewPartner(t);
						break;
					case "punishment.html":
						t = {
							entityType: "punishment",
							entityId: a.punishmentId
						}, history.pushState(null, "", "./"), dt.ViewPunishments(a);
						break;
					case "schedule.html":
						history.pushState(null, "", "./"), dt.ViewSchedule(a);
						break;
					case "rules.html":
						history.pushState(null, "", "./"), dt.ViewInfo(a);
						break;
					case "progress.html":
						history.pushState(null, "", "./"), dt.ViewProgress(a);
						break;
					case "ranking.html":
						history.pushState(null, "", "./"), dt.ViewRanking(a);
						break;
					case "settings.html":
						history.pushState(null, "", "./"), dt.ViewSettings(a);
						break;
					case "congratulations.html":
						history.pushState(null, "", "./"), dt.ViewEndgame(a);
						break;
					case "task.html":
						t = {
							entityType: "task",
							entityId: a.taskId
						}, history.pushState(null, "", "./"), dt.ViewTask(t)
				}
			} catch (t) {
				console.log(t), alert(`ERROR - ${t}.`)
			}
		}
	}
]);